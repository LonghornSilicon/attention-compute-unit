...
On non-outlier workloads the cache achieves $\approx 2\times$ compression
with MAE $<$0.02, validated by 45 passing tests covering correctness,
compression, autoregressive append, and multi-layer storage.
