...
│   └── runner_setup_prompt.md    # Copy-paste commands for the always-on runner box
├── .github/workflows/ci.yml      # CI: functional verif → synth → Sky130 signoff → paper build
└── README.md (this file)
```
...
| `openlane-sky130` | **self-hosted (your cloud box)** | Full Sky130 signoff; **fails CI if any violation** |
